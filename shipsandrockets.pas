...
begin
 glPushMatrix;
   ...
   EnemyShipVRMLs[Kind].Render(nil);
 glPopMatrix;
end;
...
begin
 ...
 result :=
   (levelScene.DefaultTriangleOctree.SegmentCollision(ShipPos, newShipPos,
     false, NoItemIndex, false) = NoItemIndex) and
...
begin
 ...
 if (levelScene.DefaultTriangleOctree.SegmentCollision(rocPos,
       newRocPos, false, NoItemIndex, false) <> NoItemIndex) or
